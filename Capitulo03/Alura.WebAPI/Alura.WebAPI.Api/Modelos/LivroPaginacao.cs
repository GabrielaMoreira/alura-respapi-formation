...
namespace Alura.ListaLeitura.Api.Modelos
{
    ...
    {
        public static LivroPaginado ToLivroPaginado(this IQueryable<LivroApi> query, LivroPaginado paginacao)
        {
            ...
            return new LivroPaginado{ 
                ...
                Anterior = (paginacao.Pagina > 1) ? 
                    $"livros?tamanho={paginacao.Pagina-1}&paginacao{paginacao.Tamanho}" : "",
